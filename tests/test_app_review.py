...
several lines must collapse to one entry (this previously crashed the review
screen with duplicate Streamlit form keys)."""
from core.engine import dedupe_flags
